...
const ICONS = {
  ...
  edgeoffset: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7"><path d="M5 4v16M19 4v16"/><path d="M5 12h6"/><path d="M13 12h.01"/><path d="M9 9l3 3-3 3"/></svg>',
...
const TOOL_DEFS = {
  ...
  free: [
    ...
    { id: 'edgeoffset', label: 'Offset Line/Arc', key: '' },
