...
const SUITE = [
  ...
  'edgeoffset', 'rebar', 'multiface', 'faceorient', 'lineheal', 'looseface', 'edgesel', 'nestface', 'thicken', 'hostedcuts', 'ifcexport', 'annotate', 'room', 'independence', 'layers', 'linestyle', 'mirrorarray',
