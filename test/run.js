...
const SUITE = [
  ...
  'edgeoffset', 'rebar', 'columnrebar', 'elementrebar', 'beamconn', 'wallopening', 'fndkinds', 'multiface', 'faceorient', 'lineheal', 'looseface', 'edgesel', 'nestface', 'thicken', 'hostedcuts', 'ifcexport', 'annotate', 'room', 'deletebatch', 'independence', 'layers', 'linestyle', 'mirrorarray',
