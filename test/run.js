...
const SUITE = [
  ...
  'edgeoffset', 'rebar', 'columnrebar', 'multiface', 'faceorient', 'lineheal', 'looseface', 'edgesel', 'nestface', 'thicken', 'hostedcuts', 'ifcexport', 'annotate', 'room', 'independence', 'layers', 'linestyle', 'mirrorarray',
