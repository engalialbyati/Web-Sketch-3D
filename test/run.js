...
const SUITE = [
  ...
  'edgeoffset', 'rebar', 'columnrebar', 'elementrebar', 'multiface', 'faceorient', 'lineheal', 'looseface', 'edgesel', 'nestface', 'thicken', 'hostedcuts', 'ifcexport', 'annotate', 'room', 'independence', 'layers', 'linestyle', 'mirrorarray',
